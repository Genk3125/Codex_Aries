...
- `docs/codex-integration-caveats.md`: Codex 導入時の落とし穴と対処
...
追加の導入 caveat は [codex-integration-caveats.md](/Users/kondogenki/Codex_Aries/docs/codex-integration-caveats.md) にまとめる。
