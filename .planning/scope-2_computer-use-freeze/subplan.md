...
- [ ] ユースケースが列挙され、それぞれに In/Out 判定がついている
- [ ] 技術選定（MCP / direct / API）が決定し、理由が文書化されている
- [ ] Phase 12 の実装 scope が cu-scope-decision.md に凍結されている
- [ ] scope freeze 後の変更は「明示的な unfreeze 判断」を必要とする
